...
ActiveRecord::Schema.define(version: 2023_03_04_103233) do
  ...
  create_table "device_comment_goods", force: :cascade do |t|
  ...
  create_table "device_genres", force: :cascade do |t|
    t.string "device_genre_name", default: "", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end

  create_table "device_goods", force: :cascade do |t|
    t.integer "user_id", null: false
  ...
  create_table "devices", force: :cascade do |t|
    ...
    t.text "device_caption", default: "", null: false
  ...
  create_table "game_comment_goods", force: :cascade do |t|
    t.integer "user_id", null: false
  ...
  create_table "game_genres", force: :cascade do |t|
    t.string "game_genre_name", default: "", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end

  create_table "game_goods", force: :cascade do |t|
    t.integer "user_id", null: false
    t.integer "game_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  ...
  create_table "games", force: :cascade do |t|
    ...
    t.text "game_caption", default: "", null: false
    t.integer "price", null: false
